...
# More examples copied from https://docs.manim.community/en/stable/examples.html below (class names are pretty self-explanatory):
...
class PolygonOnAxes(Scene):
    ...
    def construct(self):
        ...
        dot = Dot()
        dot.add_updater(lambda x: x.move_to(
            ax.c2p(t.get_value(), k / t.get_value())))
        dot.set_z_index(10)
